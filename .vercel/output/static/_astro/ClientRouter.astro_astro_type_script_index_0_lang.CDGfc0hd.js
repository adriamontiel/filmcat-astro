...
function re(e) {
  const t = document.documentElement,
    n = [...t.attributes].filter(({ name: o }) => (t.removeAttribute(o), ne.includes(o)));
...
async function be(e, t, n, o, r, i, u, a, c) {
  ...
  return (
    document.dispatchEvent(d) &&
      (await d.loader(),
      d.defaultPrevented || (pe(me), d.navigationType !== 'traverse' && D({ scrollX, scrollY }))),
    d
  );
}
...
async function Ae(e, t) {
  try {
    ...
    return i !== 'text/html' && i !== 'application/xhtml+xml'
      ? null
      : { html: await o.text(), redirected: o.redirected ? o.url : void 0, mediaType: i };
  } catch {
    return null;
  }
}
...
const z = (e, t, n, o, r) => {
  ...
  if (e.href !== location.href && !r)
    ...
    } else history.pushState({ ...n.state, index: ++v, scrollX: 0, scrollY: 0 }, '', e.href);
  if (
    ((document.title = u),
    (S = e),
    ...
    if (e.hash) {
      ...
      ((location.href = e.href),
        history.state ||
          (history.replaceState(c, ''), i && window.dispatchEvent(new PopStateEvent('popstate'))));
  ...
  async function i(d) {
    function l(f) {
      ...
      return !w || !(w instanceof KeyframeEffect) || !w.target
        ? !1
        : window.getComputedStyle(w.target, w.pseudoElement).animationIterationCount === 'infinite';
    }
...
async function J(e, t, n, o, r) {
  ...
  async function c(s) {
    ...
    if (s.formData) {
      ...
      b.body =
        t !== void 0 &&
        Reflect.get(HTMLFormElement.prototype, 'attributes', p).getNamedItem('enctype')?.value ===
